...
class ResNet50_FAM(nn.Module):
    ...
    def forward(self, haze, clean):
        ...
        real_clean_dis = self.Resnet50_forward_for_test(CF)
        real_haze_dis = self.Resnet50_forward_for_test(DF)
        fake_clean_dis = self.Resnet50_forward_for_test(fake_DF_1)
        fake_haze_dis = self.Resnet50_forward_for_test(fake_CF_1)
    ...
    def optimize(self, clean, haze, DF, CF, fake_DF_1, fake_DF_2, fake_CF_1, fake_CF_2, real_clean_dis, real_haze_dis, fake_clean_dis, fake_haze_dis):
        ...
        loss_G = self.backward_G(DF, CF, fake_DF_1, fake_DF_2, fake_CF_1, fake_CF_2, real_clean_dis, real_haze_dis, fake_clean_dis, fake_haze_dis)
    ...
    def backward_G(self, DF, CF, fake_DF_1, fake_DF_2, fake_CF_1, fake_CF_2, real_clean_dis, real_haze_dis, fake_clean_dis, fake_haze_dis):
        # L_adv
