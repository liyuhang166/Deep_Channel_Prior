...
class Vgg16_FAM(nn.Module):
    ...
    def forward(self, haze, clean):
        ...
        real_clean_dis1, real_clean_dis2 = self.Vgg_forward_for_test(CF)
        real_haze_dis1, real_haze_dis2 = self.Vgg_forward_for_test(DF)
        fake_clean_dis1, fake_clean_dis2 = self.Vgg_forward_for_test(fake_DF_1)
        fake_haze_dis1, fake_haze_dis2 = self.Vgg_forward_for_test(fake_CF_1)
    ...
    def backward_G(self, DF, CF, fake_DF_1, fake_DF_2, fake_CF_1, fake_CF_2, real_clean_dis1, fake_clean_dis1, real_haze_dis1, fake_haze_dis1, real_clean_dis2, fake_clean_dis2, real_haze_dis2, fake_haze_dis2):
        ...
        Adv_loss_GD2C = Adv_loss_GD2C1 + Adv_loss_GD2C2 + Adv_loss_GD2C3
        Adv_loss_GC2D = Adv_loss_GC2D1 + Adv_loss_GC2D2 + Adv_loss_GC2D3
        # L_cyc
